...
<form method="post" enctype="multipart/form-data">
    ...
    <label>Könyv borító:<br>
        ...
        <?php if (!empty($bookData['cover_url'])): ?>
            <br><small>Jelenlegi borító:<br>
                <img src="<?= htmlspecialchars($bookData['cover_url']) ?>" 
                     alt="Könyv borító" 
        ...
        <select name="author_id" required>
            <?php foreach ($data['authors'] as $author): ?>
                <option value="<?= $author['id'] ?>" 
                    <?= $author['id'] == $bookData['author_id'] ? 'selected' : '' ?>>
        ...
        <select name="publisher_id" required>
            <?php foreach ($data['publishers'] as $publisher): ?>
                <option value="<?= $publisher['id'] ?>" 
                    <?= $publisher['id'] == $bookData['publisher_id'] ? 'selected' : '' ?>>
        ...
        <select name="category_id" required>
            <?php foreach ($data['categories'] as $category): ?>
                <option value="<?= $category['id'] ?>" 
                    <?= $category['id'] == $bookData['category_id'] ? 'selected' : '' ?>>
